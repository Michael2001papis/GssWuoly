 ...
 *
 * ⚠️ סטטוס: לא בשימוש – איפוס סיסמה במייל לא מופעל בפרויקט זה.
 *    להפעלה: הגדר מפתחות אמיתיים למטה וצרף לוגיקת איפוס סיסמה.
 *    להסרה: אם אין צורך – מחק קובץ זה ו־vendor/email.min.js
 *
 * הוראות התקנה:
